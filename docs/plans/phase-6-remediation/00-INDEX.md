...
| CHAT RESTORE | `task-13-readme-demo.md` (WR-18) | WR-18 | BLOCKED on chat restore; author stopped correctly + surfaced the outage; resumes after prod redeploy (fix count 8→7) |
